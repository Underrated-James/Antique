...
export default function SellerPage() {
  ...
  const themePrimary = "#7a5e3b"; // earthy brown
  const themeLight = "#d9caa3";   // light beige
    ...
    datasets: [
      {
        label: 'Visits',
        data: monthlyVisits,
        backgroundColor: `${themePrimary}99`, // semi-transparent
      ...
      <div className={styles.container}>
        ...
        <main className={styles.content}>
          <div className="container-fluid py-3">
            <h2 className="text-center mb-4" style={{ color: themePrimary }}>
              Seller {username} Dashboard
            </h2>
            ...
            <div className="row g-3 mb-4">
              {[
                { icon: "bi-box-seam-fill", label: "Total Products", value: stats.totalProducts },
                { icon: "bi-eye-fill", label: "Shop Visitors", value: stats.visitors },
                { icon: "bi-star-fill", label: "Best-Selling", value: stats.popular },
                { icon: "bi-fire", label: "Trending", value: stats.trending },
              ].map((item, i) => (
                <div className="col-12 col-sm-6 col-md-4 col-lg-3" key={i}>
                  <div className="card text-center shadow-sm h-100" style={{ borderColor: themePrimary }}>
                    <div className="card-body">
                      <h5 className="card-title" style={{ color: themePrimary }}>
                        <i className={`bi ${item.icon} me-2`}></i>{item.label}
                      </h5>
                      <p className="fs-3 fw-bold" style={{ color: themePrimary }}>{item.value}</p>
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="row g-3 mb-4">
              <div className="col-lg-8">
                <div className="card h-100 shadow-sm">
                  <div className="card-header text-white" style={{ backgroundColor: themePrimary }}>Most Viewed Item</div>
                  <div className="card-body text-center">
                    {stats.mostViewedItem && stats.mostViewedItem.product_name ? (
                      <>
                        <img
                          src={stats.mostViewedItem.image1_path?.startsWith('/uploads/')
                      ...
                      <p className="text-muted">No data inputed yet</p>
                    )}
                  </div>
                </div>
              </div>
              <div className="col-lg-4">
                <div className="card h-100 shadow-sm">
                  <div className="card-header text-white" style={{ backgroundColor: themePrimary, color: themePrimary }}>Product Categories</div>
            ...
            <div className="row g-3 mb-4">
              <div className="col-lg-12">
                <div className="card h-100 shadow-sm">
                  <div className="card-header text-white" style={{ backgroundColor: themePrimary }}>Monthly Visitor Count</div>
            ...
            <div className="row g-3 mb-4">
              ...
              <div className="col-lg-6">
                <div className="card h-100 shadow-sm">
                  <div className="card-header text-white" style={{ backgroundColor: themePrimary }}>Revenue Summary</div>
                  <div className="card-body">
                    <div className="row text-center">
                      <div className="col-6">
                        <h4 style={{ color: themePrimary }}>₱{revenueData.totalRevenue.toFixed(2)}</h4>
                        <p className="text-muted">Total Revenue</p>
                      </div>
                      <div className="col-6">
                        <h4 style={{ color: themePrimary }}>{revenueData.totalOrders}</h4>
                        ...
                        <ul className="list-unstyled">
                          {revenueData.topProducts.slice(0, 3).map((product, index) => (
                            <li key={index} className="d-flex justify-content-between">
                              ...
                              <span style={{ color: themePrimary }}>₱{parseFloat(product.revenue).toFixed(2)}</span>
                            </li>
                          ))}
                        </ul>
                      </div>
              ...
              <div className="col-lg-6">
                <div className="card h-100 shadow-sm">
                  <div className="card-header text-white" style={{ backgroundColor: themePrimary }}>Revenue by Category</div>
            ...
            <div className="row g-3 mb-4">
              <div className="col-lg-12">
                <div className="card h-100 shadow-sm">
                  <div className="card-header text-white" style={{ backgroundColor: themePrimary }}>Monthly Revenue</div>
                  <div className="card-body" style={{ height: "400px" }}>
            ...
            <div className="row g-3">
              <div className="col-lg-12">
                <div className="card shadow-sm">
                  <div className="card-header text-white" style={{ backgroundColor: themePrimary, color: themePrimary }}>Quick Access</div>
